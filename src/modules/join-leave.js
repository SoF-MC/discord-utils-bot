            ...
            guild.channels.cache.get("764179432147124304").send(`<@${member.user.id}>,`, {
                embed: {
                    ...
                    description: [
                        ...
                        "Хотите получить доступ без ожиданий? Вы можете купить проходку за 50 рублей. [Реквизиты](https://canary.discord.com/channels/764178286233518100/818887949764263966) **Заметка: в описании напишите свой ник, что бы избежать проблем.**",
