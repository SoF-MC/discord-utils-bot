            ...
            guild.channels.cache.get("764179432147124304").send(`<@${member.user.id}>,`, {
                embed: {
                    ...
                    description: [
                        ...
                        "Хотите получить доступ без ожиданий? Вы можете купить проходку за 100 рублей. Вся информация находится в канале <#764181132119375902>. **Заметка: в описании напишите свой ник, что бы избежать проблем.**",
